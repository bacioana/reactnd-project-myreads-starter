...
class BooksApp extends React.Component {
  ...
  render() {
    return (     
      <div>
        <BookList 
          books={this.state.books.filter((book) => book.read === 'currentlyReading')}
          shelf='Currently Reading'
          />
        <BookList 
          books={this.state.books.filter((book) => book.read === 'wantToRead')} 
          shelf='Want to Read'
          />
        <BookList 
          books={this.state.books.filter((book) => book.read === 'read')} 
          shelf='Read'
          />
      </div>
    )
